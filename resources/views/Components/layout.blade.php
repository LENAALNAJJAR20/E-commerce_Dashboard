                ...
                <nav class="navbar  navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div id="focus" class="nav-item dropdown">
                            ...
                            <div id="focus" class="dropdown-menu bg-transparent border-0">
                                <a href="{{route('products.index')}}" class="dropdown-item">All Product</a>
                        ...
                        <div id="focus" class="nav-item dropdown">
                            ...
                            <div id="focus" class="dropdown-menu bg-transparent border-0">
                                <a href="{{route('categories.index')}}" class="dropdown-item">All Category</a>
                                <a href="{{route('categories.create')}}" class="dropdown-item">Add New Category</a>
                            </div>
                        </div>
                        <div id="focus" class="nav-item dropdown">
                            <a href="{{route('wishlist')}}" class="nav-link nav-link">
                                <i class="fas fa-heart" aria-hidden="true"></i>
                                Wishlist
                            </a>
                            <div id="focus" class="nav-item dropdown">
                                <a href="{{route('cart')}}" class="nav-link nav-link">
            ...
            <div class="navbar-nav align-items-center ms-auto">
                <div class="nav-item dropdown">
                    ...
                    <div id="focus"
                        ...
                        <a href="{{route('message')}}" class="dropdown-item text-center">See all message</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
