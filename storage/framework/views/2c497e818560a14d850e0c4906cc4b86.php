    ...
    <section class="vh-100 mt-5 mb-5" style="background-color: #ffffff;">
        <div class="container h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-xl-9">
                    <h1 class="text-center mb-4" style="color: black ">Edit user <?php echo e($user->name); ?>  </h1>
                    <form action="<?php echo e(route('users.update',$user->id)); ?>" method="POST" class="card"
...
<?php echo $__env->make('Components.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenaJo\Desktop\Product_manage\e-commerce\resources\views/Users/edit.blade.php ENDPATH**/ ?>